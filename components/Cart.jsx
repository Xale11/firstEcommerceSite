...
import {TiDeleteOutline, TiFlowParallel} from "react-icons/ti"
...
const Cart = () => {
  ...
  const handleCheckout = async () => {
    ...
    const response = await fetch("/api/stripe", {method: "POST", headers: {"Content-Type": "application/json"}, body: JSON.stringify(cartItems)} )
