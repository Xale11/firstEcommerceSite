import product from "@/ecommercesanity/schemas/product";
...
export const StateContext = ({children}) => {
    ...
    return(
        <Context.Provider value={{setTotalQuantities, setTotalPrice, showCart, setShowCart, cartItems, setCartItems, totalPrice, totalQuantities, qty, incQty, decQty, onAdd, toggleCartItemQuantity, onRemove}}>
            {children}
        </Context.Provider>
    )
}
